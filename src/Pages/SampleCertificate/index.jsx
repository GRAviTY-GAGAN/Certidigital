...
const SampleCertificate = () => {
  ...
  const handleFieldsData = (shapes) => {
    ...
    fetch(
      "https://certidigital-backend.onrender.com/certificate/generate-image",
      {
        method: "POST",
        headers: {
  ...
  useEffect(() => {
    ...
    canvas.style.background = `url(https://certidigital-backend.onrender.com/template/singletemplate/${id})`;
