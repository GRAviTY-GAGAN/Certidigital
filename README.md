...
5. Open https://certidigital-backend.onrender.com to backend run in the browser (npm run dev)

## Test Credentials

_To login in the app as admin use email demoAdmin@gmail.com and password Admin@123_  
_To login in the app as student use email demoStudent@gmail.com and password Student@123_
